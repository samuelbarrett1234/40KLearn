...
class NNModel:
    def __init__(self):
        ...
        self.policy_head = layers.Dense(256, activation='relu')(self.policy_head)
        self.policy_head = layers.Dense(2 * BOARD_SIZE * BOARD_SIZE + 1, activation=None)(self.policy_head)
        ...
        # position for the next action. The final element of the array represents
        # the logit probability of ending phase (a 'pass').
    ...
    def train(self, input_array, values, policies):
        ...
        # policies: should be a list of 2D arrays of the same size as 2 * BOARD_SIZE * BOARD_SIZE + 1
        self.model.fit(input_array, [values, policies], epochs=NUM_EPOCHS)

    def run(self, input_array):
        # input array: should be of the form <list of board representations as tensors, list of phases as vectors>
        # values: will be a list of scalars
        # policies: will be a list of 2D arrays of the same size as 2 * BOARD_SIZE * BOARD_SIZE + 1
